...
//Our MySQL user account. define('MYSQL_USER', 'aluno'); 

//Our MySQL password. define('MYSQL_PASSWORD', 'aluno');   

//The server that MySQL is located on. define('MYSQL_HOST', 'localhost'); 
 
//The name of our database. define('MYSQL_DATABASE', 'pdo_sessao_02_bd_2info2'); 
